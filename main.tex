...
\begin{minipage}[t]{\textwidth}
  ...
  \begin{skills}
    ...
    \skillset{Other}{Git, SVN, Design Pattern, MVC, Jira, Confluence, Agile Methodology, Selenium and JUnit Automation Test}
  \end{skills}
\end{minipage}
...
\begin{entrylist}
  \entry
  {Sep '20 -- present\\\footnotesize{Belo Horizonte, MG, Brazil}}
  {Equity Sales Trader | RIVA Investments/ XP Investments}
  {}
  {Executing client orders, identifying new marketplace trends, ensuring risk management, providing expert analysis on market conditions and providing trading ideas.\\
    \begin{contributionlist}
      \contribution{Manage client relationships, identifying produtcs opportunities to buy, sell or hold. Calling and telling them what research is relevant to them, and what merchandise I have, if there's any news on any of their positions.}
      \contribution{Development of analysis documents.}
    \end{contributionlist}\\
  \entry
  {Jun '19 -- Aug '20\\\footnotesize{Belo Horizonte, MG, Brazil}}
  {Investment Adivisor | Lotus Capital/ BTG Pactual Bank}
  {}
  {Responsable for internals operational process of account opening, products and data analysis.\\
    \begin{contributionlist}
      ...
      \contribution{Solving problemas and developing analysis tools with Python and Google Sheets.}
    \end{contributionlist}\\
